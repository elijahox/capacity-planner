// ================================================================
// DEFAULT STATE — used by db.js to seed an empty database
// ================================================================
// This mirrors the initial data from public/js/data.js so that a
// fresh Postgres instance starts with the correct baseline state.
// Keep in sync with data.js if defaults ever change.
...
const defaultState = {
  ...
  initiatives: [
    {id:'ppng',      name:'PPNG',                     tier:1, status:'Delivery',      owner:'C&S', allocations:{ppngcx:100,ppngint:100,ppecom:30,ppinstore:5}, budget:null, estimatedCapacity:{}, estimatedHeadcount:null, expectedStart:null, expectedDuration:null, sponsor:'C&S', pipelineStatus:'in_delivery', estimatedRoles:[]},
    {id:'rocket_i',  name:'Project Rocket',            tier:1, status:'Delivery',      owner:'C&S', allocations:{fandc:10,persloy:10,chatbot:100,rocket:100},   budget:null, estimatedCapacity:{}, estimatedHeadcount:null, expectedStart:null, expectedDuration:null, sponsor:'C&S', pipelineStatus:'in_delivery', estimatedRoles:[]},
    {id:'nzmkt',     name:'NZ Marketplace',            tier:2, status:'Delivery',      owner:'C&S', allocations:{mktplace:90},                                  budget:null, estimatedCapacity:{}, estimatedHeadcount:null, expectedStart:null, expectedDuration:null, sponsor:'C&S', pipelineStatus:'in_delivery', estimatedRoles:[]},
    {id:'nzloy',     name:'NZ Loyalty',                tier:2, status:'Delivery',      owner:'C&S', allocations:{persloy:10,nzloy_cp:80},                       budget:null, estimatedCapacity:{}, estimatedHeadcount:null, expectedStart:null, expectedDuration:null, sponsor:'C&S', pipelineStatus:'in_delivery', estimatedRoles:[]},
    {id:'tyrewise',  name:'TyreWise',                  tier:2, status:'Delivery',      owner:'C&S', allocations:{checkout:30},                                  budget:null, estimatedCapacity:{}, estimatedHeadcount:null, expectedStart:null, expectedDuration:null, sponsor:'C&S', pipelineStatus:'in_delivery', estimatedRoles:[]},
    {id:'uteboot',   name:'Ute & Boot Delivery',       tier:2, status:'Delivery',      owner:'C&S', allocations:{checkout:25},                                  budget:null, estimatedCapacity:{}, estimatedHeadcount:null, expectedStart:null, expectedDuration:null, sponsor:'C&S', pipelineStatus:'in_delivery', estimatedRoles:[]},
    {id:'ocean',     name:'Project Ocean',             tier:2, status:'Delivery',      owner:'C&S', allocations:{fandc:15,mktplace:10,payments:10,ppngint:10},  budget:null, estimatedCapacity:{}, estimatedHeadcount:null, expectedStart:null, expectedDuration:null, sponsor:'C&S', pipelineStatus:'in_delivery', estimatedRoles:[]},
    {id:'stripe',    name:'Stripe',                    tier:2, status:'Business Case', owner:'C&S', allocations:{payments:20},                                  budget:null, estimatedCapacity:{}, estimatedHeadcount:null, expectedStart:null, expectedDuration:null, sponsor:'C&S', pipelineStatus:'in_delivery', estimatedRoles:[]},
    {id:'redsba',    name:'Reds in BA',                tier:2, status:'Delivery',      owner:'C&S', allocations:{findplan:20},                                  budget:null, estimatedCapacity:{}, estimatedHeadcount:null, expectedStart:null, expectedDuration:null, sponsor:null,  pipelineStatus:'in_delivery', estimatedRoles:[]},
    {id:'ppecom_i',  name:'PP Ecom',                   tier:2, status:'Delivery',      owner:'C&S', allocations:{ppecom:100},                                   budget:null, estimatedCapacity:{}, estimatedHeadcount:null, expectedStart:null, expectedDuration:null, sponsor:'C&S', pipelineStatus:'in_delivery', estimatedRoles:[]},
    {id:'retailmfa', name:'Retail MFA',                tier:2, status:'Delivery',      owner:'C&S', allocations:{payments:20},                                  budget:null, estimatedCapacity:{}, estimatedHeadcount:null, expectedStart:null, expectedDuration:null, sponsor:'C&S', pipelineStatus:'in_delivery', estimatedRoles:[]},
    {id:'sfcrm_i',   name:'Salesforce CRM',            tier:2, status:'Delivery',      owner:'C&S', allocations:{sfcrm:90},                                     budget:null, estimatedCapacity:{}, estimatedHeadcount:null, expectedStart:null, expectedDuration:null, sponsor:'C&S', pipelineStatus:'in_delivery', estimatedRoles:[]},
    {id:'futsch',    name:'Future of Search',          tier:3, status:'Delivery',      owner:null,  allocations:{fandc:40,mktplace:5},                          budget:null, estimatedCapacity:{}, estimatedHeadcount:null, expectedStart:null, expectedDuration:null, sponsor:null,  pipelineStatus:'in_delivery', estimatedRoles:[]},
    {id:'loyback',   name:'Loyalty Backlog',           tier:3, status:'Delivery',      owner:null,  allocations:{persloy:100},                                  budget:null, estimatedCapacity:{}, estimatedHeadcount:null, expectedStart:null, expectedDuration:null, sponsor:null,  pipelineStatus:'in_delivery', estimatedRoles:[]},
    {id:'incident',  name:'Incident Management',       tier:3, status:'Delivery',      owner:null,  allocations:{fandc:5,mktplace:10,chatbot:10,ppinstore:30,findplan:70}, budget:null, estimatedCapacity:{}, estimatedHeadcount:null, expectedStart:null, expectedDuration:null, sponsor:null, pipelineStatus:'in_delivery', estimatedRoles:[]},
    {id:'apigee',    name:'APIGEE X Migration',        tier:3, status:'Delivery',      owner:null,  allocations:{fandc:20,mktplace:10,checkout:7,payments:45,discover:35,findplan:50}, budget:null, estimatedCapacity:{}, estimatedHeadcount:null, expectedStart:null, expectedDuration:null, sponsor:null, pipelineStatus:'in_delivery', estimatedRoles:[]},
    {id:'futcart',   name:'Future of Cart',            tier:3, status:'Delivery',      owner:null,  allocations:{checkout:20},                                  budget:null, estimatedCapacity:{}, estimatedHeadcount:null, expectedStart:null, expectedDuration:null, sponsor:null,  pipelineStatus:'in_delivery', estimatedRoles:[]},
    {id:'crt',       name:'Core Retail Transformation',tier:1, status:'Assess',        owner:null,  allocations:{},                                             budget:null, estimatedCapacity:{}, estimatedHeadcount:null, expectedStart:null, expectedDuration:null, sponsor:null,  pipelineStatus:'in_delivery', estimatedRoles:[]},
  ],
